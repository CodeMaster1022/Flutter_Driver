...
class _RegisterVchiclePageState extends State<RegisterVchiclePage> {
  ...
  Widget build(BuildContext context) {
    ...
    print('Name:${driverViewModel.driver.fullName}');
    print('Email:${driverViewModel.driver.email}');
    print('phonenumber:${driverViewModel.driver.phoneNumber}');
    print('password:${driverViewModel.driver.password}');
    print('confirm:${driverViewModel.driver.passwordConfirmation}');
    print('type:${driverViewModel.driver.carType}');
    print('number:${driverViewModel.driver.carPhoto}');
